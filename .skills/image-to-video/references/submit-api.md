...
| Item | Details |
|------|---------|
| Endpoint | `POST https://app-b0t9jb6nl2pt-api-rY7JZvg0dqdL.gateway.appmedo.com/v1/videos/image2video` |
...
async function submitImageToVideo(params: {
  ...
  const response = await fetch(
    "https://app-b0t9jb6nl2pt-api-rY7JZvg0dqdL.gateway.appmedo.com/v1/videos/image2video",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
